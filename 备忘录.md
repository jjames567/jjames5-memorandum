...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601205858779.png" alt="image-20210601205858779" style="zoom:50%; margin-left: -10px;" />

但是实际在 redis 中，这些数据类型是以对象的形式存在的。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601205955696.png" alt="image-20210601205955696" style="zoom: 33%; margin-left: -10px;" />
...
![image-20210601205549162](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601205549162.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601210817212.png" alt="image-20210601210817212" style="zoom: 50%; margin-left: -10px" /> 

EMBSTR：当 value 长度 <= 44时使用，只需要分配一次内存(空间连续)来创建 redisObject + sdshdr，同时回收内存时也只需要一次，数据不能进行修改，否则会变成RAW。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601211701992.png" alt="image-20210601211701992" style="zoom:50%; margin-left: -10px" />

RAW：当 value 长度 > 44时使用，需要分配两次内存来创建 redisObject 和 sdshdr。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601211957261.png" alt="image-20210601211957261" style="zoom: 50%; margin-left: -10px;" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601214554508.png" alt="image-20210601214554508" style="zoom:50%; margin-left:-10px" />

LINKEDLIST：双向链表

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601214658856.png" alt="image-20210601214658856" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601221121864.png" alt="image-20210601221121864" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601221627155.png" alt="image-20210601221627155" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601223351654.png" alt="image-20210601223351654" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601230622836.png" alt="image-20210601230622836" style="zoom:50%; margin-left:-10px" />

SKIPLIST：跳跃表，插入时间复杂度为 O(logn)，查找时间复杂度为 O(1) 。典型的空间换时间。

![image-20210601230831031](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601230831031.png)

##### BITMAP

也称作位图，使用二进制数组实现，

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210603201824525.png" alt="image-20210603201824525" style="zoom: 33%; margin-left: -10px;" />

假如我们要记录用户是否有登录，就可以使用用户id作为 key ，数组下标作为天数，置1代表已经登录，类似下面这样：

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210603203607133.png" alt="image-20210603203607133" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210601233243548.png" alt="image-20210601233243548" style="zoom: 33%; margin-left: -10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210602225134835.png" alt="image-20210602225134835" style="zoom:50%;" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210603003122032.png" alt="image-20210603003122032" style="zoom: 33%; margin-left: -10px;" />

**引入个 发布订阅模式 小插曲，便于后面的知识**

发布订阅模式可以看这篇文章：https://zhuanlan.zhihu.com/p/353505620

其实模式就是用来匹配频道的，比如 student.1 频道，我可以订阅 student.* 模式，就能同时涵盖多个频道。它的底层实际上是一个频道对应一个链表，存的是已经订阅了该频道的客户端。订阅模式也是一个链表，节点存的是客户端和模式。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210625164552679.png" alt="image-20210625164552679" style="zoom:33%; margin-left:-5px" />

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210625164621464.png" alt="image-20210625164621464" style="zoom:33%; margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210603234049201.png" alt="image-20210603234049201" style="zoom: 33%; margin-left:-10px" />

redis 会把数据划分为 **16384** 个槽位slot，相当于把内存数据分片到各个主节点。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210604001306507.png" alt="image-20210604001306507" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210604001501497.png" alt="image-20210604001501497" style="zoom: 50%;margin-left:-10px" />
...
2. **System 系统类加载器**：加载tomcat启动的类，比如 bootstrap.jar，通常在 catalina.bat 或者 catalina.sh 中指定。位于`CATALINA_HOME/bin`下
   ...
   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210807212850226.png" alt="image-20210807212850226" style="zoom:33%; margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210807220929751.png" alt="image-20210807220929751" style="zoom:33%; margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606154915784.png" alt="image-20210606154915784" style="zoom:50%; margin-left:-10px" />
...
![image-20210606155123672](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606155123672.png)

Map 接口中 **方法** 的 **符号引用** ，因为对象类型是 Map 接口。

![image-20210606155408765](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606155408765.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605135546698.png" alt="image-20210605135546698" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605135615240.png" alt="image-20210605135615240" style="zoom:33%; margin-left:-10px" />

#### 栈

栈的结构如下：

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606002909885.png" alt="image-20210606002909885" style="zoom: 33%; margin-left: -10px;" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606132646439.png" alt="image-20210606132646439" style="zoom:33%; margin-left:-10px" />

为了节省栈帧的空间，这些 slot **是可以复用的**，当方法的执行位置超过了某个变量，这个变量的 slot 就可以被其他变量复用。与此同时，slot 的复用也影响了垃圾回收的行为。比如看下面的代码：

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606134930474.png" alt="image-20210606134930474" style="zoom: 33%; margin-left:-10px" />

能看到 bytes 变量并没有被垃圾回收，因为该变量 **还在作用域内** ，那我们稍微把代码改一下。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606135039251.png" alt="image-20210606135039251" style="zoom:33%; margin-left:-10px" />

可以看到即使加了代码块使得 byte 变量超出作用域，但仍未被回收，我们再尝试改一下代码。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606135217992.png" alt="image-20210606135217992" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606135725524.png" alt="image-20210606135725524" style="zoom: 50%; margin-left:-10px" />

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606135713017.png" alt="image-20210606135713017" style="zoom: 33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606142616225.png" alt="image-20210606142616225" style="zoom: 50%; margin-left:-10px" />

对应的操作栈如下：

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606142659332.png" alt="image-20210606142659332" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606162627082.png" alt="image-20210606162627082" style="zoom: 33%; margin-left:-10px" />
...
2. 为该对象 **分配内存空间** ，其中有 **指针碰撞** 和 **空闲列表** 两种方法。
   ...
   - 指针碰撞：在内存空间中，空间是 **规整的** ，分为已分配空间和未分配空间，这因此只需要在未分配内存中移动 对象大小相等 的距离就行。
     ...
     <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605211709047.png" alt="image-20210605211709047" style="zoom: 33%; margin-left:-10px" />

   - 空闲列表：空间是 **不规整的** ，因此需要维护一个空闲列表来记录内存中哪些地方是可用的，根据这个列表找到一个足够大的空间分配给该对象。

     <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605212056840.png" alt="image-20210605212056840" style="zoom:33%; margin-left:-10px" />
...
3. **初始化零值**：为实例对象的字段初始化为零值（不包括对象头），解释了为什么实例属性能直接引用。
   ...
   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605220357165.png" alt="image-20210605220357165" style="zoom: 50%; margin-left:-10px" />

4. **设置对象头**：

   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605221332066.png" alt="image-20210605221332066" style="zoom:33%; margin-left:-10px" />
...
1. **句柄**：会在堆中划分一块内存作为 **句柄池** ，reference 指向该句柄池。
   ...
   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605224301502.png" alt="image-20210605224301502" style="zoom: 33%;margin-left:-10px" />

   注意其中包含了对象类型信息和实例数据信息。

2. **直接指针**：直接指向堆中的实例数据，指向方法区中的对象类型信息。

   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210605224611633.png" alt="image-20210605224611633" style="zoom:33%;margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606210139391.png" alt="image-20210606210139391" style="zoom: 50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210606225115833.png" alt="image-20210606225115833" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607100434003.png" alt="image-20210607100434003" style="zoom: 33%;margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607101440627.png" alt="image-20210607101440627" style="zoom:33%;margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607102614994.png" alt="image-20210607102614994" style="zoom: 50%; margin-left: -10px;" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607135501056.png" alt="image-20210607135501056" style="zoom: 33%;margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607140548245.png" alt="image-20210607140548245" style="zoom: 50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607141400514.png" alt="image-20210607141400514" style="zoom:50%; margin-left:-10px" />

1. 初始标记 ：标记 **老年代 GC Roots 直接引用的对象**、**年轻代引用到老年代的对象**，会导致stw。

   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607144734358.png" alt="image-20210607144734358" style="zoom: 33%; margin-left:-10px" />
...
2. 并发标记：与用户线程同时运行，采取 **三色标记法** 来标记引用对象。
   ...
   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210805222733150.png" alt="image-20210805222733150" style="zoom: 25%; margin-left:-5px" />

   在当前情况执行A.B = null，但A已经是黑色了，不可能再遍历A的关联对象，同时B已经是灰色了，不会对其进行清除。这里的B对象称之为 **浮动垃圾**。

   错标：

   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210805223029147.png" alt="image-20210805223029147" style="zoom: 33%; margin-left: -5px;" />
   ...
   <img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607145016669.png" alt="image-20210607145016669" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607151048733.png" alt="image-20210607151048733" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607152207083.png" alt="image-20210607152207083" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210809231908999.png" alt="image-20210809231908999" style="zoom:33%;margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210607161214377.png" alt="image-20210607161214377" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210805214542618.png" alt="image-20210805214542618" style="zoom:50%; margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608110613070.png" alt="image-20210608110613070" style="zoom:50%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608132545289.png" alt="image-20210608132545289" style="zoom: 25%; margin-left:-10px" />

此时 CPU B 也需要读取该数据，在读取时 CPU A 嗅探到 CPU B 读取了该变量，于是把两边的缓存行设置为 Shared 状态。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608133124386.png" alt="image-20210608133124386" style="zoom:25%;margin-left:-10px" />

CPU A 对 x 变量计算完成后，将缓存行状态改为 Modified ，同时通知其他缓存了该变量的 CPU，它们会将本地缓存行状态改为 Invalid 。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608134931938.png" alt="image-20210608134931938" style="zoom: 33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608151702867.png" alt="image-20210608151702867" style="zoom:33%;margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608170439950.png" alt="image-20210608170439950" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608153858643.png" alt="image-20210608153858643" style="zoom:33%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210608142625169.png" alt="image-20210608142625169" style="zoom: 25%; margin-left:-10px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210609000104827.png" alt="image-20210609000104827" style="zoom: 50%; margin-left:-10px" />
...
![image-20210614144931481](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614144931481.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614150034153.png" alt="image-20210614150034153" style="zoom:50%;margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614151213913.png" alt="image-20210614151213913" style="zoom:33%; margin-left:-5px" />

Mark Word 是 Java 实现锁的一个很重要的部分，它的结构图如下：

![image-20210614151428141](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614151428141.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614212746708.png" alt="image-20210614212746708" style="zoom:33%; margin-left:-5px" />

#### 重量级锁

当升级为重量级锁后，Mark Word 指向的 Monitor 对象地址。

<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210614205125794.png" alt="image-20210614205125794" style="zoom:50%; margin-left:-5px" />
...
![synchronize](C:\Users\jjames5\OneDrive\图片\typora-user-images\synchronize.jpg)
...
![image-20210616164249823](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210616164249823.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210616174059803.png" alt="image-20210616174059803" style="zoom:50%;margin-left:-5px" />
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210616212956682.png" alt="image-20210616212956682" style="zoom:33%; margin-left:-5px" />
...
![image-20210617232738939](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210617232738939.png)
...
<img src="C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210703162735384.png" alt="image-20210703162735384" style="zoom: 33%; margin-left:-5px" />
...
![image-20210626160909034](C:\Users\jjames5\OneDrive\图片\typora-user-images\image-20210626160909034.png)
